...
_EXECUTOR_MODULES: dict[WarpExecutorKey, str] = {
    "gvs": "soromox.execution.warp.gvs.executor",
    "pcs": "soromox.execution.warp.pcs.executor",
}
_FUSED_EXECUTOR_MODULES: dict[WarpExecutorKey, str] = {
    "gvs": "soromox.execution.warp.gvs.fused_executor",
    "pcs": "soromox.execution.warp.pcs.fused_executor",
}
_KINEMATICS_EXECUTOR_MODULES: dict[WarpExecutorKey, str] = {
    "gvs": "soromox.execution.warp.gvs.kinematics_executor",
    "pcs": "soromox.execution.warp.pcs.kinematics_executor",
}
_ACTUATION_EXECUTOR_MODULES: dict[WarpExecutorKey, str] = {
    "gvs": "soromox.execution.warp.gvs.actuation.executor",
    "pcs": "soromox.execution.warp.pcs.actuation.executor",
}
