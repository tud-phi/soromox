...
_PUBLIC_MODULES = {
    ...
    "PCSFloatingOperands": "operands",
    "PCSFloatingPipelineShapes": "operands",
    ...
    "launch_planar_floating_persistent_chain": "planar_floating_kernels",
    ...
    "launch_spatial_floating_persistent_chain": "spatial_floating_kernels",
    "planar_local_operators_kernel": "planar_kernels",
    "planar_persistent_chain_kernel": "planar_kernels",
    "planar_floating_persistent_chain_kernel": "planar_floating_kernels",
    "spatial_local_operators_kernel": "spatial_kernels",
    "spatial_persistent_chain_kernel": "spatial_kernels",
    "spatial_floating_persistent_chain_kernel": "spatial_floating_kernels",
    ...
    "launch_forward_kinematics_and_jvp": "kinematics",
    "launch_inertial_jacobian_vjp": "kinematics",
    "launch_inertial_jacobians": "kinematics",
    "launch_planar_forward_kinematics_and_jvp": "planar_directional_kinematics",
    "launch_planar_inertial_jacobian_vjp": "planar_directional_kinematics",
    "planar_pose_twist_samples_kernel": "planar_directional_kinematics",
    "planar_sample_vjp_kernel": "planar_directional_kinematics",
    "planar_segment_pose_twist_kernel": "planar_directional_kinematics",
    "planar_segment_vjp_kernel": "planar_directional_kinematics",
    "launch_spatial_forward_kinematics_and_jvp": "spatial_directional_kinematics",
    "launch_spatial_inertial_jacobian_vjp": "spatial_directional_kinematics",
    "spatial_pose_twist_samples_kernel": "spatial_directional_kinematics",
    "spatial_sample_vjp_kernel": "spatial_directional_kinematics",
    "spatial_cooperative_segment_vjp_kernel": "spatial_directional_kinematics",
    "spatial_segment_pose_twist_kernel": "spatial_directional_kinematics",
    "spatial_segment_vjp_kernel": "spatial_directional_kinematics",
