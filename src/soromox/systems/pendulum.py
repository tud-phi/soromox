...
class Pendulum(DynamicalSystem):
    ...
    def __init__(
        ...
        Args:
            params: Dictionary with robot parameters with keys
                ...
                - "q_rest_k": rest configuration of the torsional springs defined in K (N,) (optional)
        """
        ...
        self.q_rest_k = jnp.asarray(params.get("q_rest_k", jnp.zeros((n_q,))))
    ...
    def update_params(self, params: Dict[str, Array]) -> "Pendulum":
        ...
        Args:
            params (Dict[str, Array]): Dictionary with robot parameters. Supported keys:
                ...
                - "q_rest_k": rest configuration of the torsional springs defined in K (N,) [rad] (optional)
        ...
        if "q_rest_k" in params:
            updated = eqx.tree_at(lambda x: x.q_rest_k, updated, jnp.asarray(params["q_rest_k"]))
        return updated
    ...
    def elastic_energy(self, q: Array) -> Array:
        ...
        """
        U_K = 0.5 * (q - self.q_rest_k).T @ self.stiffness_matrix() @ (q - self.q_rest_k)
        return U_K
