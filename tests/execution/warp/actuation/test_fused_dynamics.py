...
from soromox.execution.warp.gvs.operands import GVSOperands
from soromox.execution.warp.pcs.actuation.operands import (
    PCSThreadlikeOperands,
)
from soromox.execution.warp.pcs.operands import PCSOperands
...
def test_gvs_and_pcs_enable_fused_system_dispatch(
    ...
    monkeypatch.setattr(
        "soromox.execution.dispatch.jax.default_backend",
        lambda: device,
    )
