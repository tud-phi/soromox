...
load("end_effector_position_Planar_PCS_SoRoSim.mat")
...
T = readtable("end_effector_position_Planar_PyElastica.xlsx");
kkk=15;
...
T1 = readtable("end_effector_position_Planar_PCS_SoRoMoX.csv");
kkk=10;
