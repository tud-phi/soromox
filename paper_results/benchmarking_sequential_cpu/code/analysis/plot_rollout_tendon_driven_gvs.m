...
load(fullfile(data_dir, 'end_effector_position_tendon_driven_gvs_sorosim.mat'))
...
T = readtable(fullfile(data_dir, 'end_effector_position_tendon_driven_pyelastica.xlsx'));
kkk=15;
...
T1 = readtable(fullfile(data_dir, 'end_effector_position_tendon_driven_gvs_soromox.csv'));
kkk=10;
