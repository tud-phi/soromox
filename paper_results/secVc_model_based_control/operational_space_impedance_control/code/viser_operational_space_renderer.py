...
SURFACE_FILL_RGB = np.array([0xAF, 0xC0, 0xCB], dtype=np.float64) / 255.0
SURFACE_MESH_RGB = np.array([0x5F, 0x73, 0x82], dtype=np.float64) / 255.0
...
SURFACE_FILL_OPACITY = 0.16
SURFACE_MESH_OPACITY = 0.38
