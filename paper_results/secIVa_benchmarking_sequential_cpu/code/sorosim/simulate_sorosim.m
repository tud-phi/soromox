...
switch Case
   case 1
      load(fullfile(script_dir, 'system_planar_pcs.mat'));
      output_file = 'end_effector_position_planar_pcs_sorosim.mat';
   case 2
      load(fullfile(script_dir, 'system_spatial_pcs.mat'));
      output_file = 'end_effector_position_spatial_pcs_sorosim.mat';
   case 3
      load(fullfile(script_dir, 'system_complex_gvs.mat'));
      output_file = 'end_effector_position_complex_gvs_sorosim.mat';
   otherwise
      load(fullfile(script_dir, 'system_tendon_driven_gvs.mat'));
